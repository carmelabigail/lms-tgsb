...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h2 style="color:green;"><b>Register New Employee</b></h2>
</div>
              ...
              <div class="m-0">
                ...
                <legend class="col-form-label col-sm-2 pt-0"><b class="text-success">Gender</b></legend>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="position" class="form-control" id="position" value="" name="position">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="ic number" class="form-control" id="ic_no" value="" name="ic_no">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="address" class="form-control" name="address" id="address" value="" name="address">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="phonenumber" class="form-control" name="phonenumber" id="phone" value="" name="phonenumber">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="dob" class="form-control" id="email" name="email" value="">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label for="approvedleave" class="col-sm-2 col-form-label font-weight-bolder text-success"><b>Approved Leave: </b></label>
                        <div class="col-sm-10">
                            <input type="approvedleave" readonly class="form-control" id="approved_leave" name="approved_leave" value="0">
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-success btn-block"><b>Register</b></button>
                    </div>
